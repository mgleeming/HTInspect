...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.HT_RV_hitlist = QtWidgets.QTableWidget(self.tab_6)
        ...
        self.HT_RV_up = QtWidgets.QPushButton(self.tab_6)
        self.HT_RV_up.setObjectName("HT_RV_up")
        self.horizontalLayout_23.addWidget(self.HT_RV_up)
        self.HT_RV_down = QtWidgets.QPushButton(self.tab_6)
        ...
        self.HT_RV_accepted_list = QtWidgets.QTableWidget(self.tab_6)
        ...
        self.HT_RV_remove = QtWidgets.QPushButton(self.tab_6)
        self.HT_RV_remove.setObjectName("HT_RV_remove")
        self.horizontalLayout_24.addWidget(self.HT_RV_remove)
        self.HT_RV_write = QtWidgets.QPushButton(self.tab_6)
        ...
        self.HT_RV_accept = QtWidgets.QPushButton(self.tab_6)
        self.HT_RV_accept.setObjectName("HT_RV_accept")
        self.horizontalLayout_28.addWidget(self.HT_RV_accept)
        self.HT_RV_reject = QtWidgets.QPushButton(self.tab_6)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_16.setText(_translate("Dialog", "Heat Map"))
